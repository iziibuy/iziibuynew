...
it('shows overview handling actions on the booking index', function (): void {
    ...
    $this->actingAs($owner)
        ...
        ->assertSee('btn-copy-booking', false)
        ->assertSee('icon-sms.svg', false)
        ->assertSee('icon-copy-link.svg', false)
        ->assertSee('icon-email.svg', false)
        ->assertSee('icon-invoice.svg', false)
        ->assertSee('icon-copy.svg', false)
